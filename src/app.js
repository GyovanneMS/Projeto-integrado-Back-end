...
router.get('/informacoesDosCursos', cors(), async function(request, response, next){
...
router.get('/nome/:sigla', cors(), async function(request, response, next){
    //recebe a sigla enviada por parametro no endpoint
...
router.get('/alunos/:curso', cors(), async function(request, response, next){
    //recebe a sigla enviada por parametro no endpoint
...
router.get('/disciplinas/:matricula', cors(), async function(request, response, next){
    //recebe a sigla enviada por parametro no endpoint
...
router.get('/informacoes/:matricula', cors(), async function(request, response, next){
    //recebe a sigla enviada por parametro no endpoint
    let aluno = request.params.matricula;
...
router.get('/status/:sigla', cors(), async function(request, response, next){
    //recebe a sigla enviada por parametro no endpoint
    let sigla = request.params.sigla;
    let status = request.query.status;
